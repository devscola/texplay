...
describe TexPlay do
  ...
  describe "#create_image" do
    it "should create a blank image of the correct size" do
      width, height = 30, 10
      image = described_class.create_image(width, height)
    ...
    it "should create a coloured image of the correct size" do
      ...
      image = described_class.create_image(width, height, :color => color)
    ...
    it "should raise an error if an image dimension is 0 or less" do
      lambda { described_class.create_image(0, 0)}.should raise_error(ArgumentError)
    end
    ...
    it "should raise an ArgumentError if the image would be too large" do
      ...
      [[too_big, 5], [10, too_big], [too_big, too_big]].each do |width, height|
        ...
        lambda {
          described_class.create_image(width, height)
  ...
  describe "#clear" do
    it "should clear an image to the correct color" do
      img = described_class.create_image(10, 10)
      img.clear :color => :red
  ...
  describe "#from_blob" do
    ...
    #   image = described_class.from_blob((gosu_colors * height).flatten.pack('C*'), width, height)
    ...
    it "should raise an error if the image size is not correct for the blob data" do
      lambda { described_class.from_blob([1, 1, 1, 1].pack("C*"), 2, 1) }.should raise_error(ArgumentError)
    end

    it "should raise an error if an image dimension is 0 or less" do
      lambda { described_class.from_blob('', 0, 0) }.should raise_error(ArgumentError)
    end
  end

  describe "alpha_blend" do
    it "should alpha blend using source alpha and not fixing alpha" do
      img1 = described_class.create_image(10, 10).clear :color => [1, 0, 0, 1]
    ...
    it "should alpha blend using dest alpha and not fixing alpha" do
      img1 = described_class.create_image(10, 10).clear :color => [1, 0, 0, 0.5]
